...
class AdminPremiumPostsListInstanceData {
...
class AdminPremiumPostsListController extends MyController {
  ...
  Map<int, AdminPremiumPostsListInstanceData> data = {};

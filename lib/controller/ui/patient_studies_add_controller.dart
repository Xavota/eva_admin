...
class PatientStudiesAddInstanceData {
...
class PatientStudiesAddController extends MyController {
  ...
  late final ContextInstance contextInstance = ContextInstance(
    ...
    onInstanceAdded: (index) {
      data[index] = PatientStudiesAddInstanceData();
  ...
  Map<int, PatientStudiesAddInstanceData> data = {};
  ...
  void goToList() {
    Get.toNamed('/patient/studies/list');
  }
  ...
  Future<String?> onRegister(int instanceIndex) async {
    ...
    if (basicValidator.validateForm()) {
      ...
      var registerInfo = await DBManager.instance!.registerStudy(
        ...
        instanceData.loggedPatient!.userNumber,
        pdfName, true,
      );

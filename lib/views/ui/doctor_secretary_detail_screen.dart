...
import 'package:medicare/controller/ui/doctor_secretary_detail_controller.dart';
...
class DoctorSecretaryDetailScreen extends StatefulWidget {
  const DoctorSecretaryDetailScreen({super.key});

  @override
  State<DoctorSecretaryDetailScreen> createState() => _DoctorSecretaryDetailScreenState();
}

class _DoctorSecretaryDetailScreenState extends State<DoctorSecretaryDetailScreen> with UIMixin {
  DoctorSecretaryDetailController controller = Get.put(DoctorSecretaryDetailController());

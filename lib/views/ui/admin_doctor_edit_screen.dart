...
import 'package:medicare/controller/ui/admin_doctor_edit_controller.dart';
...
class AdminDoctorEditScreen extends StatefulWidget {
  const AdminDoctorEditScreen({super.key});

  @override
  State<AdminDoctorEditScreen> createState() => _AdminDoctorEditScreenState();
}

class _AdminDoctorEditScreenState extends State<AdminDoctorEditScreen> with UIMixin {
  AdminDoctorEditController controller = Get.put(AdminDoctorEditController());

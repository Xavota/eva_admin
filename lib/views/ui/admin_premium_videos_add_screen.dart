...
import 'package:medicare/controller/ui/admin_premium_videos_add_controller.dart';
...
class AdminPremiumVideosAddScreen extends StatefulWidget {
  const AdminPremiumVideosAddScreen({super.key});

  @override
  State<AdminPremiumVideosAddScreen> createState() => _AdminPremiumVideosAddScreenState();
}

class _AdminPremiumVideosAddScreenState extends State<AdminPremiumVideosAddScreen> with UIMixin {
  AdminPremiumVideosAddController controller = Get.put(AdminPremiumVideosAddController());
  ...
  void initState() {
    ...
    controller.updateInfo(instanceIndex, header, subHeader);
                    ...
                    children: [
                      ...
                      MyBreadcrumb(
                        children: [
                          ...
                          MyBreadcrumbItem(name: 'Nuevo video', active: true),
                        ],
                      ),
                    ],
                  ),
                        ...
                        Row(
                          ...
                          children: [
                              ...
                              onTap: () {
                                controller.onRegister(instanceIndex).then((validationError) {
                                  if (validationError != null) {
                                    ...
                                    if (context.mounted) {
                                      simpleSnackBar(context, "Video publicado con éxito", contentTheme.success);// Color(0xFF35639D));
                                    }
                            ...
                            MyContainer(
                              ...
                              color: contentTheme.primary,
                              borderRadiusAll: 8,
                              child: MyText.labelMedium("Publicar y Crear Nuevo", color: contentTheme.onPrimary, fontWeight: 600),
                            ),
                          ],
                        )
                      ],

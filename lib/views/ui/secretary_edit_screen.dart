...
import 'package:medicare/controller/ui/secretary_edit_controller.dart';


import 'package:blix_essentials/blix_essentials.dart';


class SecretaryEditScreen extends StatefulWidget {
  const SecretaryEditScreen({super.key});

  @override
  State<SecretaryEditScreen> createState() => _SecretaryEditScreenState();
}

class _SecretaryEditScreenState extends State<SecretaryEditScreen> with UIMixin {
  SecretaryEditController controller = Get.put(SecretaryEditController());

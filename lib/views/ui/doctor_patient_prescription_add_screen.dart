...
import 'package:medicare/controller/ui/doctor_patient_prescription_add_controller.dart';
...
class DoctorPatientPrescriptionAddScreen extends StatefulWidget {
  const DoctorPatientPrescriptionAddScreen({super.key});

  @override
  State<DoctorPatientPrescriptionAddScreen> createState() => _DoctorPatientPrescriptionAddScreenState();
}

class _DoctorPatientPrescriptionAddScreenState extends State<DoctorPatientPrescriptionAddScreen> with UIMixin {
  DoctorPatientPrescriptionAddController controller = Get.put(DoctorPatientPrescriptionAddController());
  ...
  Widget build(BuildContext context) {
    return Layout(
      child: GetBuilder(
        init: controller,
        tag: 'doctor_patient_prescription_add_controller',
        builder: (controller) {
          return Column(
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: 'Registrar Receta', active: true),
                      ],
                    ),
                  ],
                ),
                ...
                child: MyContainer(
                  ...
                  child: MyForm(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        MyText.bodyMedium("Registro de Receta", fontWeight: 600, muted: true),
                        MySpacing.height(20),
                        commonTextField(
                          ...
                          onTap: () {
                            controller.onRegister().then((validationError) {
                              if (validationError != null) {
                                ...
                                if (!context.mounted) return;
                                simpleSnackBar(context, "Receta registrada con éxito", contentTheme.success);// Color(0xFF35639D));
                              }
                            });
                          },

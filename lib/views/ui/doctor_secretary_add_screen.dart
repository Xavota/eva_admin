...
import 'package:medicare/controller/ui/doctor_secretary_add_controller.dart';


import 'package:blix_essentials/blix_essentials.dart';


class DoctorSecretaryAddScreen extends StatefulWidget {
  const DoctorSecretaryAddScreen({super.key});

  @override
  State<DoctorSecretaryAddScreen> createState() => _DoctorSecretaryAddScreenState();
}

class _DoctorSecretaryAddScreenState extends State<DoctorSecretaryAddScreen> with UIMixin {
  DoctorSecretaryAddController controller = Get.put(DoctorSecretaryAddController());

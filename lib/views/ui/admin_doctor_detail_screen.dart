...
import 'package:medicare/controller/ui/admin_doctor_detail_controller.dart';
...
class AdminDoctorDetailScreen extends StatefulWidget {
  const AdminDoctorDetailScreen({super.key});

  @override
  State<AdminDoctorDetailScreen> createState() => _AdminDoctorDetailScreenState();
}

class _AdminDoctorDetailScreenState extends State<AdminDoctorDetailScreen> with UIMixin {
  AdminDoctorDetailController controller = Get.put(AdminDoctorDetailController());

...
import 'package:medicare/controller/ui/admin_premium_posts_add_controller.dart';
...
class AdminPremiumPostsAddScreen extends StatefulWidget {
  const AdminPremiumPostsAddScreen({super.key});

  @override
  State<AdminPremiumPostsAddScreen> createState() => _AdminPremiumPostsAddScreenState();
}

class _AdminPremiumPostsAddScreenState extends State<AdminPremiumPostsAddScreen> with UIMixin {
  AdminPremiumPostsAddController controller = Get.put(AdminPremiumPostsAddController());

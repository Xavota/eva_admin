...
class PatientPremiumPostsListScreen extends StatefulWidget {
  const PatientPremiumPostsListScreen({super.key});

  @override
  State<PatientPremiumPostsListScreen> createState() => _PatientPremiumPostsListScreenState();
}

class _PatientPremiumPostsListScreenState extends State<PatientPremiumPostsListScreen> with SingleTickerProviderStateMixin, UIMixin {
  PatientPremiumPostsListController controller = Get.put(PatientPremiumPostsListController());
  ...
  Widget build(BuildContext context) {
    ...
    return Layout(
      ...
      MyContainer(
        ...
        paddingAll: 0,
        margin: EdgeInsets.fromLTRB(screenType.isMobile ? 0.0 : 20.0, screenType.isMobile ? 0.0 : 100.0, 0.0, 0.0),
        child: Center(
          child: MyContainer(
            color: Colors.white,
            marginAll: 20.0,
            child: Column(
              ...
              children: [
                ...
                MyText.bodyLarge(
                  "Activa tu cuenta premium y disfruta de todo este contenido especializado para ti."
                      "\nConsulta con tu médico para activar tu suscripción.",
      ...
      child: GetBuilder(
        ...
        builder: (controller) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            ...
            //controller.contextInstance.calculateContentSize(instanceIndex, "content", flexSpacing + contentPadding, contentPadding, firstFrame);
          ...
          //Debug.log("cardsWidth: $cardsWidth", overrideColor: Colors.purple);
          ...
          //Debug.log("globalSize: $globalSize", overrideColor: Colors.orange);
                  ...
                  child: Center(
                    child: MyText.bodyLarge(
                      "Esta categoría no existe o fue eliminada."
                        "\nIntente con una categoría válida.",
...
class PostDialogWide extends StatefulWidget {
  ...
  final PatientPremiumPostsListController controller;

...
import 'package:medicare/controller/ui/secretary_dates_list_controller.dart';
...
class SecretaryDatesListScreen extends StatefulWidget {
  const SecretaryDatesListScreen({super.key});

  @override
  State<SecretaryDatesListScreen> createState() => _SecretaryDatesListScreenState();
}

class _SecretaryDatesListScreenState extends State<SecretaryDatesListScreen> with UIMixin {
  SecretaryDatesListController controller = Get.put(SecretaryDatesListController());
  ...
  Widget build(BuildContext context) {
    ...
    final tableFlexWidth = (1541 - 324 - (1920 - screenWidth));
                          ...
                          child: DataTable(
                              ...
                              rows: controller.dates
                                ...
                                cells: [
                                  ...
                                  DataCell(SizedBox(width: 85, child: MyText.bodySmall(data.phoneNumber))),

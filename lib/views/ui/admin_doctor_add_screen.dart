...
import 'package:medicare/controller/ui/admin_doctor_add_controller.dart';
...
class AdminDoctorAddScreen extends StatefulWidget {
  const AdminDoctorAddScreen({super.key});

  @override
  State<AdminDoctorAddScreen> createState() => _AdminDoctorAddScreenState();
}

class _AdminDoctorAddScreenState extends State<AdminDoctorAddScreen> with UIMixin {
  AdminDoctorAddController controller = Get.put(AdminDoctorAddController());

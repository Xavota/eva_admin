import 'package:medicare/controller/ui/cards_controller.dart';
...
import 'package:medicare/helpers/widgets/my_progress_bar.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: MyFlex(
                  children: [
                    MyFlexItem(
                        sizes: 'lg-2.4 md-6', child: crmStateCard("\$347M", "Annual Profit", LucideIcons.briefcase, "5.23%", contentTheme.primary)),
                    MyFlexItem(
                        sizes: 'lg-2.4 md-6',
                        child: crmStateCard("\$23,345", "Daily average Income", LucideIcons.wallet, "5.23%", contentTheme.secondary)),
                    MyFlexItem(
                        sizes: 'lg-2.4 md-6', child: crmStateCard("33%", "Lead Conversation", LucideIcons.radio, "5.23%", contentTheme.danger)),
                    MyFlexItem(sizes: 'lg-2.4 md-6', child: crmStateCard("392", "Campaign sent", LucideIcons.rocket, "5.23%", contentTheme.info)),
                    MyFlexItem(
                        sizes: 'lg-2.4', child: crmStateCard("12,678", "Annual Deals", LucideIcons.heart_handshake, "7.93%", contentTheme.warning)),
                    ...
                    MyFlexItem(
                        sizes: 'xl-2 lg-4 md-6 sm-12', child: jobStateCard(LucideIcons.file_input, contentTheme.secondary, "Apply Jobs", "5678564")),
                    MyFlexItem(sizes: 'xl-2 lg-4 md-6 sm-12', child: jobStateCard(LucideIcons.user_plus, contentTheme.success, "New Jobs", "5678564")),
                    MyFlexItem(
                        sizes: 'xl-2 lg-4 md-6 sm-12', child: jobStateCard(LucideIcons.book_open_check, contentTheme.info, "Interview", "5678564")),
                    MyFlexItem(sizes: 'xl-2 lg-4 md-6 sm-12', child: jobStateCard(LucideIcons.award, contentTheme.warning, "Hired", "5678564")),
                    MyFlexItem(
                        sizes: 'xl-2 lg-4 md-6 sm-12', child: jobStateCard(LucideIcons.git_pull_request, contentTheme.danger, "Rejected", "5678564")),
                    MyFlexItem(
                    ...
                    MyFlexItem(
                        sizes: 'lg-4 md-6',
                        child: nftCard(
                            "Color Abstract -NFT", Images.dummy[0], Images.avatars[1], "Bloom NFT", "@bloom678", "0.43", "Last 4 days", "1.23k")),
                  ],
                ),
              ),
            ],

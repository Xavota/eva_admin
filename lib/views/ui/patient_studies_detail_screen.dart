...
import 'package:medicare/controller/ui/patient_studies_detail_controller.dart';
...
class PatientStudiesDetailScreen extends StatefulWidget {
  const PatientStudiesDetailScreen({super.key});

  @override
  State<PatientStudiesDetailScreen> createState() => _PatientStudiesDetailScreenState();
}

class _PatientStudiesDetailScreenState extends State<PatientStudiesDetailScreen> with UIMixin {
  PatientStudiesDetailController controller = Get.put(PatientStudiesDetailController());
  ...
  void initState() {
    ...
    controller.updateInfo(instanceIndex, index).then((_) {
      setState(() {});
    });
  }
...
class ImageDialogWide extends StatefulWidget {
  ...
  final PatientStudiesDetailController controller;

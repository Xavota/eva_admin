...
import 'package:medicare/controller/ui/doctor_patient_edit_controller.dart';


import 'package:blix_essentials/blix_essentials.dart';


class DoctorPatientEditScreen extends StatefulWidget {
  const DoctorPatientEditScreen({super.key});

  @override
  State<DoctorPatientEditScreen> createState() => _DoctorPatientEditScreenState();
}

class _DoctorPatientEditScreenState extends State<DoctorPatientEditScreen> with UIMixin {
  DoctorPatientEditController controller = Get.put(DoctorPatientEditController());
                            ...
                            MyContainer(
                              onTap: () {
                                controller.onUpdate().then((validationError) {
                                  DBManager.instance!.getPatients(doctorOwnerID: AuthService.loggedUserNumber);

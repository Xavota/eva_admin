...
import 'package:medicare/controller/ui/admin_doctor_list_controller.dart';
...
class _AdminDoctorListScreenState extends State<AdminDoctorListScreen> with UIMixin {
  late AdminDoctorListController controller;

  @override
  void initState() {
    super.initState();
    controller = AdminDoctorListController();
  }

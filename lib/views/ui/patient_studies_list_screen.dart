...
import 'package:medicare/controller/ui/patient_studies_list_controller.dart';
...
class PatientStudiesListScreen extends StatefulWidget {
  const PatientStudiesListScreen({super.key});

  @override
  State<PatientStudiesListScreen> createState() => _PatientStudiesListScreenState();
}

class _PatientStudiesListScreenState extends State<PatientStudiesListScreen> with UIMixin {
  PatientStudiesListController controller = Get.put(PatientStudiesListController());
  ...
  Widget build(BuildContext context) {
    return Layout(
      child: GetBuilder(
        init: controller,
        tag: 'patient_studies_list_controller',
        builder: (controller) {
  ...
  Widget studyCard(String date, String description, bool hasDelete, [

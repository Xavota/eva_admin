...
import 'package:medicare/controller/ui/doctor_dates_list_controller.dart';
...
class DoctorDatesListScreen extends StatefulWidget {
  const DoctorDatesListScreen({super.key});

  @override
  State<DoctorDatesListScreen> createState() => _DoctorDatesListScreenState();
}

class _DoctorDatesListScreenState extends State<DoctorDatesListScreen> with UIMixin {
  DoctorDatesListController controller = Get.put(DoctorDatesListController());
  ...
  Widget build(BuildContext context) {
    ...
    return Layout(
      child: GetBuilder(
        init: controller,
        tag: 'doctor_dates_list_controller',
        builder: (controller) {
          return Column(

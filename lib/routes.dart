...
import 'package:medicare/views/ui/blank_screen.dart';
...
import 'package:medicare/views/ui/admin_doctor_earnings_list_screen.dart';
...
import 'package:medicare/views/ui/admin_premium_videos_add_screen.dart';
import 'package:medicare/views/ui/admin_premium_videos_edit_screen.dart';
...
import 'package:medicare/views/ui/doctor_patient_info_list_screen.dart';
...
import 'package:medicare/views/ui/doctor_patient_studies_list_screen.dart';
import 'package:medicare/views/ui/doctor_patient_studies_add_screen.dart';
import 'package:medicare/views/ui/doctor_patient_studies_detail_screen.dart';
...
import 'package:medicare/views/ui/patient_studies_list_screen.dart';
import 'package:medicare/views/ui/patient_studies_add_screen.dart';
import 'package:medicare/views/ui/patient_studies_detail_screen.dart';

import 'package:medicare/views/ui/patient_premium_posts_list_screen.dart';
import 'package:medicare/views/ui/patient_premium_books_list_screen.dart';
import 'package:medicare/views/ui/patient_premium_videos_list_screen.dart';
...
class AuthMiddlewareLogin extends GetMiddleware {
  AuthMiddlewareLogin([this.reRouteUrl]);

  final String? reRouteUrl;

  @override
  RouteSettings? redirect(String? route) {
    return AuthService.loginType == LoginType.kNone
        ? null : RouteSettings(name: reRouteUrl??
...
class RedirectToStartingPageMiddleware extends GetMiddleware {
  RedirectToStartingPageMiddleware(this.admin);
  final bool admin;

  @override
  RouteSettings? redirect(String? route) {
    Debug.log("RedirectToStartingPageMiddleware.redirect: AuthService.loginType = ${AuthService.loginType.name}", overrideColor: Colors.green);
    return AuthService.loginType == LoginType.kAdmin ? const RouteSettings(name: '/panel/doctor_subs/list') :
    (AuthService.loginType == LoginType.kDoctor ? const RouteSettings(name: "/doctor/patient/list") :
    (AuthService.loginType == LoginType.kSecretary ? const RouteSettings(name: "/secretary/patient/list") :
    (AuthService.loginType == LoginType.kPatient ? const RouteSettings(name: "/patient/dates/list") :
    admin ? const RouteSettings(name: "/panel/auth/login") : const RouteSettings(name: "/auth/login"))));
  }
}
...
List<GetPage<dynamic>> getPageRoute() {
  var routes = [
    ...
    GetPage(name: '/', page: () => const BlankScreen(), middlewares: [RedirectToStartingPageMiddleware(false)]),

    GetPage(name: '/auth/login', page: () => const LoginScreen(), middlewares: [AuthMiddlewareLogin()]),
    GetPage(name: '/panel/auth/login', page: () => const LoginAdminScreen(), middlewares: [AuthMiddlewareLogin()]),
    ...
    GetPage(name: '/panel', page: () => const BlankScreen(), middlewares: [RedirectToStartingPageMiddleware(true)]),
    ...
    GetPage(name: '/panel/doctor_earnings/list', page: () => const AdminDoctorEarningsListScreen(), middlewares: [AdminAuthMiddleware()]),
    ...
    GetPage(name: '/panel/premium/videos/:header/:subHeader/add', page: () => const AdminPremiumVideosAddScreen(), middlewares: [AdminAuthMiddleware()]),
    GetPage(name: '/panel/premium/videos/:header/:subHeader/:videoIndex/edit', page: () => const AdminPremiumVideosEditScreen(), middlewares: [AdminAuthMiddleware()]),
    ...
    GetPage(name: '/doctor/patient/info_list', page: () => const DoctorPatientInfoListScreen(), middlewares: [AuthMiddleware(LoginType.kDoctor)]),
    ...
    GetPage(name: '/doctor/patient/:patientIndex/studies/list', page: () => const DoctorPatientStudiesListScreen(), middlewares: [AuthMiddleware(LoginType.kDoctor)]),
    GetPage(name: '/doctor/patient/:patientIndex/studies/add', page: () => const DoctorPatientStudiesAddScreen(), middlewares: [AuthMiddleware(LoginType.kDoctor)]),
    GetPage(name: '/doctor/patient/:patientIndex/studies/:index/detail', page: () => const DoctorPatientStudiesDetailScreen(), middlewares: [AuthMiddleware(LoginType.kDoctor)]),
    ...
    GetPage(name: '/patient/studies/list', page: () => const PatientStudiesListScreen(), middlewares: [AuthMiddleware(LoginType.kPatient)]),
    GetPage(name: '/patient/studies/add', page: () => const PatientStudiesAddScreen(), middlewares: [AuthMiddleware(LoginType.kPatient)]),
    GetPage(name: '/patient/studies/:index/detail', page: () => const PatientStudiesDetailScreen(), middlewares: [AuthMiddleware(LoginType.kPatient)]),

    GetPage(name: '/patient/premium/posts/:header/:subHeader/list', page: () => const PatientPremiumPostsListScreen(), middlewares: [AuthMiddleware(LoginType.kPatient)]),
    GetPage(name: '/patient/premium/books/:header/:subHeader/list', page: () => const PatientPremiumBooksListScreen(), middlewares: [AuthMiddleware(LoginType.kPatient)]),
    GetPage(name: '/patient/premium/videos/:header/:subHeader/list', page: () => const PatientPremiumVideosListScreen(), middlewares: [AuthMiddleware(LoginType.kPatient)]),
